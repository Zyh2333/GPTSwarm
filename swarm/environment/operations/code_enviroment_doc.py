...
from swarm.environment.chatdev.env import doc
...
class EnvironmentDoc(Node):
    def __init__(self, 
                 domain: str,
                 model_name: Optional[str] = None,
                 operation_description: str = "environment doc to develop software.",
                 max_token: int = 30000,
                 id=None):
    ...
    def meta_prompt(self, node_inputs, meta_init=False):
        ...
        prompt = self.prompt_set.get_environment_doc_prompt(task, modality, language, ideas, codes)

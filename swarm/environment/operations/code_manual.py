...
from swarm.environment.chatdev.env import manual, code, doc
...
class Manual(Node):
    def __init__(self, 
                 ...
                 operation_description: str = "manual of developed software.",
                 max_token: int = 30000,
                 id=None):
    ...
    def meta_prompt(self, node_inputs, meta_init=False):
        ...
        requirements = doc.get_docs()
        prompt = self.prompt_set.get_manual_prompt(task, modality, language, ideas, codes, requirements)
    ...
    async def _execute(self, inputs: List[Any] = [], **kwargs):
        ...
        manual.update_docs(response, parse=False, predifined_filename="manual.md")
        manual.rewrite_docs()
